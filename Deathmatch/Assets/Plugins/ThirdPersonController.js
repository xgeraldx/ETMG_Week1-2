...
public var rayCaster : Transform;
public var DefaultProjectile : GameObject;
...
function CheckShoot()
{
	...
	var hitInfo : RaycastHit;
		...
		if(Physics.Raycast(rayCaster.transform.position,rayCaster.transform.forward,hitInfo, 200f))
		{
...
function UpdateSmoothedMovementDirection ()
{
	...
	var cameraTransform = gameObject.transform.parent.GetComponentInChildren(Camera).transform;
	...
	if(_animation) {
		...
		else 
		{
			...
			else 
			{
				...
				else if(_characterState == CharacterState.Shoot){
