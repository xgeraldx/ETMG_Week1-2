...
public static class PhotonNetwork
{
    ...
    private static int sendInterval = 25; // in miliseconds.

    private static int sendIntervalOnSerialize = 4; // in miliseconds. I.e. 100 = 100ms which makes 10 times/second
